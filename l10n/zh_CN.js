OC.L10N.register(
    ...
    "the rar extension is not available or unrar is not installed\n\n\t\t\t\t\t\t\t\tDEBUG(" : "rar 扩展名不可用或未安装 unrar\n\n\t\t\t\t\t\t\t\t调试（",
    "Can't find rar file" : "找不到rar文件",
    "the rar extension is not available or unrar is not installed\n\n\t\t\t\t\t\tDEBUG(" : "rar 扩展名不可用或未安装 unrar\n\n\t\t\t\t\t\t调试（",
    "Can't find rar file at " : "在以下位置不能找到 rar 文件",
    "the p7zip extension is not available or p7zip-full is not installed\n\n\t\t\t\t\t\tDEBUG(" : "p7zip 扩展名不可用或未安装 p7zip-full\n\n\t\t\t\t\t\t调试（",
    "Can't find archive on external local storage" : "在外部本地存储找不到压缩包",
    "the p7zip extension is not available or p7zip-full is not installed\n\n\t\t\t\t\tDEBUG(" : "p7zip 扩展名不可用或未安装 p7zip-full\n\n\t\t\t\t\t调试（",
