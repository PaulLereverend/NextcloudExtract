OC.L10N.register(
    ...
    "Error extracting " : "Грешка при отпакување",
    ...
    "Can't open Zip file" : "Неможе да се отвори Zip датотеката",
    ...
    "Oops something went wrong. Check that you have p7zip installed" : "Настана грешка. Проверете дали имате инсталирано p7zip",
    "Extract" : "Отпакувај",
